...
// those runs are copied without any test; the replacement logic runs only at
// the multiples. For int1=3, int2=5 (F = str1, B = str2):
//
...
//	                  ▲       ▲   ▲           ▲   ▲       ▲           ▲  events
//
// At an event, i == next1 emits str1 and advances next1 += int1, likewise for
// str2; both at once emit str1+str2. That handles int1 == int2 and
// non-coprime pairs without special cases.
//
// # Decimal counter
//
