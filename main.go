...
func run(logger *slog.Logger) error {
	...
	srv := &http.Server{
		...
		// Keeps net/http's own errors, recovered panics included, in the JSON stream.
...
// newStore does not fail on an unreachable Redis: /fizzbuzz keeps serving and
// /stats reports 503 until Redis is back.
